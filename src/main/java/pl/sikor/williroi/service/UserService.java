...
public class UserService {
    ...
    /* CONSTRUCTOR */
    public UserService(ApiService apiService, UserRepository userRepository) {
    ...
    public UserModel addHeliumAccount(UserModel userModel) {
        ...
        if (userRepository.findByUsername(userModel.getUsername()) != null) {
            ...
            user.setAccountModel(apiService.getAccountFromAPI(userModel.getHntAccount())); // gets account data from
                                                                                           // helium api
            userRepository.save(user);
            return user;
        } else {
